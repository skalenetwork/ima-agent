...
RUN apt-get update
RUN apt-get install --no-install-recommends -y build-essential python3 python3-dev zlib1g-dev libncurses5-dev libgdbm-dev libnss3-dev libssl-dev libreadline-dev libffi-dev wget curl sudo git
