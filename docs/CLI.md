...
For most of operations, **IMA** needs aliases or addresses of **Skale Manager**, **Ethereum(Main Net)**, **S-Chain(s)**:

```
--manager-contracts=aliasOrAddress........Alias or address of skale-manager contracts.
--ima-contracts=aliasOrAddress.............Alias or address of IMA Mainnet contracts.
--ima-schain-contracts=aliasOrAddress..............Alias or address of IMA sChain contracts.
```
...
```
--s2s-enable....................Enables S-Chain to S-Chain transfers. Default mode.
